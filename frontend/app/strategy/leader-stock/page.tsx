...
export default function LeaderStockPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await apiClient.getLeaderStockResults();
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-lg">Loading leader stocks...</div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Leader Stock Screener</h1>
      {selectedSymbol && (
