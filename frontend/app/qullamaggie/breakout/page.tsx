  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-lg">Loading Qullamaggie breakout results...</div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Qullamaggie의 브레이크아웃 전략에 따른 스크리닝 결과입니다.
        </p>
        <div className="mt-4">
          <Link 
            href="/qullamaggie" 
      ...
      <DataTable 
        data={filteredData} 
        columns={columns}
        title="Breakout Results"
        description={`총 ${filteredData.length}개의 브레이크아웃 후보 (전체 ${data.length}개 중)`}
      />
    </div>
  );
}