...
- Treat `data/`, `results/`, and `docs/archive/raw-sources/{Reference,PRD}/` as operator data or reference material. Do not reorganize or delete them unless explicitly asked.
